...
def main():
    ...
    L = ["\\begin{table}[t]", "\\centering",
         ...
         + " sequential lifecycles; substrate cost is Boxed minus raw hardened Docker under the same runtime, with a bootstrap 95\\% CI. Peak is the best mean sandboxes/s over the sweeps. Denied is the post-condition escape verdict, identical across 3 probe runs for every runtime.}",
         "\\label{tab:runtimes}", "\\scriptsize", "\\setlength{\\tabcolsep}{2.5pt}", "\\begin{tabular}{@{}lrrrrrr@{}}", "\\toprule",
